...
public class SQLDatabaseManager {
    ...
    private static final int SSH_PORT = 11150;
    private static final String SSH_USER = "sshuser";
    private static final String SSH_PASSWD = "1234";
    private static final String SSH_PRIVATE_KEY = "C:\\Users\\Abii\\Documents\\accesoRemoto\\accesoServidor\\id_rsa";

    private static final String DB_HOST = "127.0.0.1";
    private static final int DB_PORT = 5432;
    private static final String DB_USER = "postgres";
    private static final String DB_PASSWORD = "1234";
    private static final String DB_NAME = "consultasmedicas";
